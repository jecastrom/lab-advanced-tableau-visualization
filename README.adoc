...
link:https://public.tableau.com/views/unit-4-lab_6/Sheet5?:language=en-GB&publish=yes&:display_count=n&:origin=viz_share_link[Tableau Public: Choropleth map of the number of customers per State]
====
''''
====
